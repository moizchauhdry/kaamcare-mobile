...
import { ResetPasswordForm2o } from 'components/Forms/ResetPasswordForm/ResetPassForm2o';

export const ResetPasswordScreen2o = () => {
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.content}>
            ...
            <ResetPasswordForm2o onSubmit={authResetPass} isPending={isPending} />
          </View>
        </KeyboardAwareScrollView>
      </SafeAreaView>
    </TouchableWithoutFeedback>
